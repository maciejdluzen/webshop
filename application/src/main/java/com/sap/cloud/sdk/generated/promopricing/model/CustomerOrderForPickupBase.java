 ...
 */
@ApiModel(description = "A flavor of a line item whereby customers purchase an unavailable item. The store places a special order on behalf of this purchase, and the customers pick up the item when available. The customer may, or may not pay for the item at the time of the order placement. CustomerOrderForPickup is currently not supported. ")
...
// CHECKSTYLE:ON
{
  ...
  private List<LineItemAttributeType> lineItemAttribute = new ArrayList<>();
   ...
   /**
   * Set the any of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param any  Currently not supported.
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase any(@Nonnull final List<Object> any) {
    this.any = any;
    return this;
  }
  /**
  * Add one Any instance to this {@link CustomerOrderForPickupBase}.
  * @param anyItem The Any that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addAnyItem( @Nonnull final Object anyItem) {
    if (this.any == null) {
   ...
   * @return any  The any of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "Currently not supported.")
  @Nonnull public List<Object> getAny() {
    return any;
  }

  /**
  * Set the any of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param any  Currently not supported.
  */
  public void setAny( @Nonnull final List<Object> any) {
   ...
   /**
   * Set the itemID of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param itemID  The itemID of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase itemID(@Nonnull final List<ItemID> itemID) {
    this.itemID = itemID;
    return this;
  }
  /**
  * Add one ItemID instance to this {@link CustomerOrderForPickupBase}.
  * @param itemIDItem The ItemID that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addItemIDItem( @Nonnull final ItemID itemIDItem) {
    if (this.itemID == null) {
   ...
   /**
   * Get itemID
   * @return itemID  The itemID of this {@link CustomerOrderForPickupBase} instance.
  **/
  ...
  /**
  * Set the itemID of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param itemID  The itemID of this {@link CustomerOrderForPickupBase}
  */
  public void setItemID( @Nonnull final List<ItemID> itemID) {
   ...
   /**
   * Set the merchandiseHierarchy of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param merchandiseHierarchy  The merchandiseHierarchy of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase merchandiseHierarchy(@Nonnull final List<MerchandiseHierarchyCommonData> merchandiseHierarchy) {
    this.merchandiseHierarchy = merchandiseHierarchy;
    return this;
  }
  /**
  * Add one MerchandiseHierarchy instance to this {@link CustomerOrderForPickupBase}.
  * @param merchandiseHierarchyItem The MerchandiseHierarchy that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addMerchandiseHierarchyItem( @Nonnull final MerchandiseHierarchyCommonData merchandiseHierarchyItem) {
   ...
   * @return merchandiseHierarchy  The merchandiseHierarchy of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the merchandiseHierarchy of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param merchandiseHierarchy  The merchandiseHierarchy of this {@link CustomerOrderForPickupBase}
  */
  public void setMerchandiseHierarchy( @Nonnull final List<MerchandiseHierarchyCommonData> merchandiseHierarchy) {
   ...
   /**
   * Set the regularSalesUnitPrice of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param regularSalesUnitPrice  The regularSalesUnitPrice of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase regularSalesUnitPrice(@Nonnull final UnitPriceCommonData regularSalesUnitPrice) {
   ...
   * @return regularSalesUnitPrice  The regularSalesUnitPrice of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the regularSalesUnitPrice of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param regularSalesUnitPrice  The regularSalesUnitPrice of this {@link CustomerOrderForPickupBase}
  */
  public void setRegularSalesUnitPrice( @Nonnull final UnitPriceCommonData regularSalesUnitPrice) {
   ...
   /**
   * Set the extendedAmount of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param extendedAmount  The extendedAmount of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase extendedAmount(@Nonnull final ExtendedAmountType extendedAmount) {
   ...
   /**
   * Get extendedAmount
   * @return extendedAmount  The extendedAmount of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the extendedAmount of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param extendedAmount  The extendedAmount of this {@link CustomerOrderForPickupBase}
  */
  public void setExtendedAmount( @Nonnull final ExtendedAmountType extendedAmount) {
   ...
   /**
   * Set the extendedDiscountAmount of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param extendedDiscountAmount  The extendedDiscountAmount of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase extendedDiscountAmount(@Nonnull final AmountCommonData extendedDiscountAmount) {
   ...
   * @return extendedDiscountAmount  The extendedDiscountAmount of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the extendedDiscountAmount of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param extendedDiscountAmount  The extendedDiscountAmount of this {@link CustomerOrderForPickupBase}
  */
  public void setExtendedDiscountAmount( @Nonnull final AmountCommonData extendedDiscountAmount) {
   ...
   /**
   * Set the quantity of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param quantity  The quantity of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase quantity(@Nonnull final List<QuantityCommonData> quantity) {
    this.quantity = quantity;
    return this;
  }
  /**
  * Add one Quantity instance to this {@link CustomerOrderForPickupBase}.
  * @param quantityItem The Quantity that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addQuantityItem( @Nonnull final QuantityCommonData quantityItem) {
   ...
   /**
   * Get quantity
   * @return quantity  The quantity of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the quantity of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param quantity  The quantity of this {@link CustomerOrderForPickupBase}
  */
  public void setQuantity( @Nonnull final List<QuantityCommonData> quantity) {
   ...
   /**
   * Set the retailPriceModifier of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param retailPriceModifier  The retailPriceModifier of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase retailPriceModifier(@Nonnull final List<RetailPriceModifierDomainSpecific> retailPriceModifier) {
    this.retailPriceModifier = retailPriceModifier;
    return this;
  }
  /**
  * Add one RetailPriceModifier instance to this {@link CustomerOrderForPickupBase}.
  * @param retailPriceModifierItem The RetailPriceModifier that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addRetailPriceModifierItem( @Nonnull final RetailPriceModifierDomainSpecific retailPriceModifierItem) {
   ...
   * @return retailPriceModifier  The retailPriceModifier of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the retailPriceModifier of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param retailPriceModifier  The retailPriceModifier of this {@link CustomerOrderForPickupBase}
  */
  public void setRetailPriceModifier( @Nonnull final List<RetailPriceModifierDomainSpecific> retailPriceModifier) {
   ...
   /**
   * Set the itemLink of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param itemLink  The itemLink of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase itemLink(@Nonnull final List<ItemLink> itemLink) {
    this.itemLink = itemLink;
    return this;
  }
  /**
  * Add one ItemLink instance to this {@link CustomerOrderForPickupBase}.
  * @param itemLinkItem The ItemLink that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addItemLinkItem( @Nonnull final ItemLink itemLinkItem) {
   ...
   /**
   * Get itemLink
   * @return itemLink  The itemLink of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the itemLink of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param itemLink  The itemLink of this {@link CustomerOrderForPickupBase}
  */
  public void setItemLink( @Nonnull final List<ItemLink> itemLink) {
   ...
   /**
   * Set the itemType of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param itemType  The itemType of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase itemType(@Nonnull final String itemType) {
   ...
   /**
   * Get itemType
   * @return itemType  The itemType of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the itemType of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param itemType  The itemType of this {@link CustomerOrderForPickupBase}
  */
  public void setItemType( @Nonnull final String itemType) {
   ...
   /**
   * Set the nonDiscountableFlag of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param nonDiscountableFlag  The nonDiscountableFlag of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase nonDiscountableFlag(@Nonnull final Boolean nonDiscountableFlag) {
   ...
   * @return nonDiscountableFlag  The nonDiscountableFlag of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the nonDiscountableFlag of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param nonDiscountableFlag  The nonDiscountableFlag of this {@link CustomerOrderForPickupBase}
  */
  public void setNonDiscountableFlag( @Nonnull final Boolean nonDiscountableFlag) {
   ...
   /**
   * Set the fixedPriceFlag of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param fixedPriceFlag  The fixedPriceFlag of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase fixedPriceFlag(@Nonnull final Boolean fixedPriceFlag) {
   ...
   /**
   * Get fixedPriceFlag
   * @return fixedPriceFlag  The fixedPriceFlag of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the fixedPriceFlag of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param fixedPriceFlag  The fixedPriceFlag of this {@link CustomerOrderForPickupBase}
  */
  public void setFixedPriceFlag( @Nonnull final Boolean fixedPriceFlag) {
   ...
   /**
   * Set the taxIncludedInPriceFlag of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param taxIncludedInPriceFlag  The taxIncludedInPriceFlag of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase taxIncludedInPriceFlag(@Nonnull final Boolean taxIncludedInPriceFlag) {
   ...
   * @return taxIncludedInPriceFlag  The taxIncludedInPriceFlag of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the taxIncludedInPriceFlag of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param taxIncludedInPriceFlag  The taxIncludedInPriceFlag of this {@link CustomerOrderForPickupBase}
  */
  public void setTaxIncludedInPriceFlag( @Nonnull final Boolean taxIncludedInPriceFlag) {
   ...
   /**
   * Set the nonPieceGoodFlag of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param nonPieceGoodFlag  The nonPieceGoodFlag of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase nonPieceGoodFlag(@Nonnull final Boolean nonPieceGoodFlag) {
   ...
   * @return nonPieceGoodFlag  The nonPieceGoodFlag of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the nonPieceGoodFlag of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param nonPieceGoodFlag  The nonPieceGoodFlag of this {@link CustomerOrderForPickupBase}
  */
  public void setNonPieceGoodFlag( @Nonnull final Boolean nonPieceGoodFlag) {
   ...
   /**
   * Set the frequentShopperPointsEligibilityFlag of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param frequentShopperPointsEligibilityFlag  The frequentShopperPointsEligibilityFlag of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase frequentShopperPointsEligibilityFlag(@Nonnull final Boolean frequentShopperPointsEligibilityFlag) {
   ...
   * @return frequentShopperPointsEligibilityFlag  The frequentShopperPointsEligibilityFlag of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the frequentShopperPointsEligibilityFlag of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param frequentShopperPointsEligibilityFlag  The frequentShopperPointsEligibilityFlag of this {@link CustomerOrderForPickupBase}
  */
  public void setFrequentShopperPointsEligibilityFlag( @Nonnull final Boolean frequentShopperPointsEligibilityFlag) {
   ...
   /**
   * Set the discountTypeCode of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param discountTypeCode  The discountTypeCode of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase discountTypeCode(@Nonnull final String discountTypeCode) {
   ...
   * @return discountTypeCode  The discountTypeCode of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the discountTypeCode of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param discountTypeCode  The discountTypeCode of this {@link CustomerOrderForPickupBase}
  */
  public void setDiscountTypeCode( @Nonnull final String discountTypeCode) {
   ...
   /**
   * Set the priceTypeCode of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param priceTypeCode  The priceTypeCode of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase priceTypeCode(@Nonnull final String priceTypeCode) {
   ...
   /**
   * Get priceTypeCode
   * @return priceTypeCode  The priceTypeCode of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the priceTypeCode of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param priceTypeCode  The priceTypeCode of this {@link CustomerOrderForPickupBase}
  */
  public void setPriceTypeCode( @Nonnull final String priceTypeCode) {
   ...
   /**
   * Set the notConsideredByPriceEngineFlag of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param notConsideredByPriceEngineFlag  The notConsideredByPriceEngineFlag of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase notConsideredByPriceEngineFlag(@Nonnull final Boolean notConsideredByPriceEngineFlag) {
   ...
   * @return notConsideredByPriceEngineFlag  The notConsideredByPriceEngineFlag of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the notConsideredByPriceEngineFlag of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param notConsideredByPriceEngineFlag  The notConsideredByPriceEngineFlag of this {@link CustomerOrderForPickupBase}
  */
  public void setNotConsideredByPriceEngineFlag( @Nonnull final Boolean notConsideredByPriceEngineFlag) {
   ...
   /**
   * Set the frequentShopperPointsModifier of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param frequentShopperPointsModifier  The frequentShopperPointsModifier of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase frequentShopperPointsModifier(@Nonnull final List<FrequentShopperPointsModifierType> frequentShopperPointsModifier) {
    this.frequentShopperPointsModifier = frequentShopperPointsModifier;
    return this;
  }
  /**
  * Add one FrequentShopperPointsModifier instance to this {@link CustomerOrderForPickupBase}.
  * @param frequentShopperPointsModifierItem The FrequentShopperPointsModifier that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addFrequentShopperPointsModifierItem( @Nonnull final FrequentShopperPointsModifierType frequentShopperPointsModifierItem) {
   ...
   * @return frequentShopperPointsModifier  The frequentShopperPointsModifier of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the frequentShopperPointsModifier of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param frequentShopperPointsModifier  The frequentShopperPointsModifier of this {@link CustomerOrderForPickupBase}
  */
  public void setFrequentShopperPointsModifier( @Nonnull final List<FrequentShopperPointsModifierType> frequentShopperPointsModifier) {
   ...
   /**
   * Set the promotionPriceDerivationRuleReference of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param promotionPriceDerivationRuleReference  The promotionPriceDerivationRuleReference of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase promotionPriceDerivationRuleReference(@Nonnull final List<PromotionPriceDerivationRuleReferenceType> promotionPriceDerivationRuleReference) {
    this.promotionPriceDerivationRuleReference = promotionPriceDerivationRuleReference;
    return this;
  }
  /**
  * Add one PromotionPriceDerivationRuleReference instance to this {@link CustomerOrderForPickupBase}.
  * @param promotionPriceDerivationRuleReferenceItem The PromotionPriceDerivationRuleReference that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addPromotionPriceDerivationRuleReferenceItem( @Nonnull final PromotionPriceDerivationRuleReferenceType promotionPriceDerivationRuleReferenceItem) {
   ...
   * @return promotionPriceDerivationRuleReference  The promotionPriceDerivationRuleReference of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the promotionPriceDerivationRuleReference of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param promotionPriceDerivationRuleReference  The promotionPriceDerivationRuleReference of this {@link CustomerOrderForPickupBase}
  */
  public void setPromotionPriceDerivationRuleReference( @Nonnull final List<PromotionPriceDerivationRuleReferenceType> promotionPriceDerivationRuleReference) {
   ...
   /**
   * Set the promotionManualTrigger of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param promotionManualTrigger  The promotionManualTrigger of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase promotionManualTrigger(@Nonnull final List<PromotionManualTriggerType> promotionManualTrigger) {
    this.promotionManualTrigger = promotionManualTrigger;
    return this;
  }
  /**
  * Add one PromotionManualTrigger instance to this {@link CustomerOrderForPickupBase}.
  * @param promotionManualTriggerItem The PromotionManualTrigger that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addPromotionManualTriggerItem( @Nonnull final PromotionManualTriggerType promotionManualTriggerItem) {
   ...
   * @return promotionManualTrigger  The promotionManualTrigger of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the promotionManualTrigger of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param promotionManualTrigger  The promotionManualTrigger of this {@link CustomerOrderForPickupBase}
  */
  public void setPromotionManualTrigger( @Nonnull final List<PromotionManualTriggerType> promotionManualTrigger) {
   ...
   /**
   * Set the lineItemAttribute of this {@link CustomerOrderForPickupBase} instance and return the same instance.
   *
   * @param lineItemAttribute  The lineItemAttribute of this {@link CustomerOrderForPickupBase}
   * @return The same instance of this {@link CustomerOrderForPickupBase} class
   */
   @Nonnull public CustomerOrderForPickupBase lineItemAttribute(@Nonnull final List<LineItemAttributeType> lineItemAttribute) {
    this.lineItemAttribute = lineItemAttribute;
    return this;
  }
  /**
  * Add one LineItemAttribute instance to this {@link CustomerOrderForPickupBase}.
  * @param lineItemAttributeItem The LineItemAttribute that should be added
  * @return The same instance of type {@link CustomerOrderForPickupBase}
  */
  @Nonnull public CustomerOrderForPickupBase addLineItemAttributeItem( @Nonnull final LineItemAttributeType lineItemAttributeItem) {
   ...
   * @return lineItemAttribute  The lineItemAttribute of this {@link CustomerOrderForPickupBase} instance.
  **/
  @ApiModelProperty(value = "")
  ...
  /**
  * Set the lineItemAttribute of this {@link CustomerOrderForPickupBase} instance.
  *
  * @param lineItemAttribute  The lineItemAttribute of this {@link CustomerOrderForPickupBase}
  */
  ...
  public boolean equals(@Nonnull final java.lang.Object o) {
    ...
    final CustomerOrderForPickupBase customerOrderForPickupBase = (CustomerOrderForPickupBase) o;

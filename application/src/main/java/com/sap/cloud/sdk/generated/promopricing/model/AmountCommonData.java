 ...
 */
@ApiModel(description = "Monetary value plus currency.")
...
// CHECKSTYLE:ON
{
  ...
  private String currency;
   ...
   /**
   * Set the value of this {@link AmountCommonData} instance and return the same instance.
   *
   * @param value  The value of this {@link AmountCommonData}
   * Minimum: 0
   * @return The same instance of this {@link AmountCommonData} class
   */
   @Nonnull public AmountCommonData value(@Nonnull final BigDecimal value) {
    this.value = value;
    return this;
  }
   ...
   * Get value
   * Minimum: 0
   * @return value  The value of this {@link AmountCommonData} instance.
  **/
  ...
  /**
  * Set the value of this {@link AmountCommonData} instance.
  *
  * @param value  The value of this {@link AmountCommonData}
  * Minimum: 0
  */
  public void setValue( @Nonnull final BigDecimal value) {
   ...
   /**
   * Set the currency of this {@link AmountCommonData} instance and return the same instance.
   *
   * @param currency  Uppercase currency is expected in uppercase ISO format.
   * @return The same instance of this {@link AmountCommonData} class
   */
   @Nonnull public AmountCommonData currency(@Nonnull final String currency) {
   ...
   * @return currency  The currency of this {@link AmountCommonData} instance.
  **/
  ...
  /**
  * Set the currency of this {@link AmountCommonData} instance.
  *
  * @param currency  Uppercase currency is expected in uppercase ISO format.
  */
  ...
  public boolean equals(@Nonnull final java.lang.Object o) {
    ...
    final AmountCommonData amountCommonData = (AmountCommonData) o;

...
// CHECKSTYLE:ON
{
  ...
  private String unitOfMeasureCode;
   ...
   /**
   * Set the value of this {@link QuantityDifference} instance and return the same instance.
   *
   * @param value  Must be an integer. The overall quantity is the product of value and units. Can be positive as well as negative.
   * Minimum: -9999999999
   * Maximum: 9999999999
   * @return The same instance of this {@link QuantityDifference} class
   */
   @Nonnull public QuantityDifference value(@Nonnull final BigDecimal value) {
    this.value = value;
    return this;
  }
   ...
   * Minimum: -9999999999
   * Maximum: 9999999999
   * @return value  The value of this {@link QuantityDifference} instance.
  **/
  @ApiModelProperty(value = "Must be an integer. The overall quantity is the product of value and units. Can be positive as well as negative.")
  @Nonnull public BigDecimal getValue() {
    return value;
  }

  /**
  * Set the value of this {@link QuantityDifference} instance.
  *
  * @param value  Must be an integer. The overall quantity is the product of value and units. Can be positive as well as negative.
  * Minimum: -9999999999
  * Maximum: 9999999999
  */
  public void setValue( @Nonnull final BigDecimal value) {
   ...
   /**
   * Set the units of this {@link QuantityDifference} instance and return the same instance.
   *
   ...
   * @return The same instance of this {@link QuantityDifference} class
   */
   @Nonnull public QuantityDifference units(@Nonnull final BigDecimal units) {
    this.units = units;
    return this;
  }
   ...
   * Minimum: 0
   * Maximum: 9999999999.999
   * @return units  The units of this {@link QuantityDifference} instance.
  **/
  ...
  /**
  * Set the units of this {@link QuantityDifference} instance.
  *
  * @param units  May be fractional. Set this to one for piece like items. The overall quantity is the product of value and units.
  * Minimum: 0
  * Maximum: 9999999999.999
  */
  public void setUnits( @Nonnull final BigDecimal units) {
   ...
   /**
   * Set the unitOfMeasureCode of this {@link QuantityDifference} instance and return the same instance.
   *
   ...
   * @return The same instance of this {@link QuantityDifference} class
   */
   @Nonnull public QuantityDifference unitOfMeasureCode(@Nonnull final String unitOfMeasureCode) {
   ...
   * @return unitOfMeasureCode  The unitOfMeasureCode of this {@link QuantityDifference} instance.
  **/
  ...
  /**
  * Set the unitOfMeasureCode of this {@link QuantityDifference} instance.
  *
  * @param unitOfMeasureCode  Must match with the information specified in the promotions and regular prices. No conversion of unit of measures is done. Uppercase format.
  */
  ...
  public boolean equals(@Nonnull final java.lang.Object o) {
    ...
    final QuantityDifference quantityDifference = (QuantityDifference) o;
